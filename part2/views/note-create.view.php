            ...
            <form method="POST">
                <div class="space-y-12 px-8">
                    <div class="border-b border-gray-900/10 pb-12">
                        <h2 class="text-base font-semibold leading-7 text-gray-900 mt-8">Create</h2>
                        <p class="mt-1 text-sm leading-6 text-gray-600">This form helps you to create a new note</p>
                        <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                            <div class="col-span-full">
                                <label for="body" class="block text-sm font-medium leading-6 text-gray-900">Type your note here</label>
                                <div class="mt-2">
